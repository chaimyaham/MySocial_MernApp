    ...
    <WidgetWrapper>
        ...
        <FlexBetween  gap="0.5rem" pb="1.1rem" onClick={()=>navigate(`/profile/${userId}`)}>
            <FlexBetween gap="1rem">
                ...
                <Box>
                    ...
                    <Typography color={main}>{friends.length} friends</Typography>
                </Box>
        ...
        <Box p="1rem 0">
            <Box display="flex" alignItems="center" gap="1rem" mb="0.5rem">
                <LocationOnOutlined fontSize='medium' sx={{color:palette.primary.main}}/>
                <Typography color={medium}>{location}</Typography>

            </Box>
            <Box display="flex" alignItems="center" gap="1rem" >
                <WorkOutlined fontSize='medium' sx={{color:palette.primary.main}}/>
...
<Box p="1rem 0">
    <FlexBetween mb="0.5rem">
        <Typography color={medium}>Who viewed you Profile</Typography>
...
<Box p="1rem 0">
    <Typography color={main} fontWeight="500" fontSize="1rem" mb="1rem">
        ...
        <FlexBetween gap="1rem" mb="0.5rem">
            <FlexBetween gap="1rem">
                    <TwitterIcon sx={{color:palette.primary.main}}/>
                    <Box>
        ...
        <FlexBetween gap="1rem">
            <FlexBetween gap="1rem">
                    <LinkedInIcon sx={{color:palette.primary.main}}/>
                    <Box>
                        <Typography color={main} fontWeight="500">
                            linkedIn
                        </Typography>
